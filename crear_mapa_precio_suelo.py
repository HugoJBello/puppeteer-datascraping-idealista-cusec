...
if __name__ == '__main__':
    shapefile = "data/maps/SECC_CPV_E_20111101_01_R_INE_MADRID.shp"
    data_source = ogr.Open(shapefile, True)  # True allows to edit the shapefile
    layer = data_source.GetLayer()
    suffix = "datos_alquiler_vivienda_idealista_2018-10-17_12_18_18"
    suffix = suffix.replace("-","__")

    route_to_csv_files = "data/tmp/csv_files/"
